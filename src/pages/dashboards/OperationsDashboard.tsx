...
export function OperationsDashboard() {
  ...
  useEffect(() => {
    // Quick head request to check if operations.html has been placed in the public/reports folder
    fetch("/reports/operations.html", { method: "HEAD" })
      .then((res) => {
        if (res.ok) {
          setHasReport(true);
        } else {
